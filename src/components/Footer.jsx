...
const Footer = () => {
  const date = new Date();
  return (
    <div className="flex flex-col lg:flex-row w-full justify-between items-center lg:gap-10 border border-t-2 border-t-orange-400 lg:px-5 py-1 fixed bottom-0 bg-gray-100">
