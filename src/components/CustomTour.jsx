    ...
    return (
      <>
        ...
        >
          ...
          {tour === 0 && (
            <button
              className="uppercase py-3 px-3 lg:text-lg bg-gradient-to-r from-gsl-light-green to-gsl-dark-orange w-40 text-white rounded-md mx-auto hover:scale-105 duration-300 ease-in-out font-semibold hover:shadow-xl"
          ...
          {tour === 7 && (
            <div className="font-semibold text-black text-base flex justify-between items-center w-full gap-4">
              ...
              <button
                className="uppercase py-3 px-2 w-40 lg:text-lg bg-gradient-to-r from-gsl-light-green to-gsl-dark-orange text-white rounded-md mx-auto hover:scale-105 duration-300 ease-in-out font-semibold hover:shadow-xl"
                onClick={handleClose}
              >
                {loading ? (
