        ...
        <div className="z-50">
          ...
          <div className="absolute top-0 left-0 w-full min-h-screen bg-[#f9f9f9] z-[1]">
            ...
            <div className="w-full flex justify-center items-center">
              <button
                className="uppercase tracking-wide py-3 px-2 bg-gradient-to-r from-gsl-light-green to-gsl-dark-orange w-40 text-white rounded-md mx-auto hover:scale-105 duration-300 ease-in-out font-semibold animate-lazily"
      ...
      <div className="h-full w-full overflow-auto flex flex-col justify-center items-center gap-4 lg:py-0 py-2 lg:p-5">
        <div className="w-[90%] lg:w-[80%] m-5 p-5 shadow-2xl border-t-4 border-t-gsl-dark-orange bg-white flex flex-col items-center justify-center rounded-md gap-5 mb-10 lg:mb-20">
          ...
          {/* <div className="flex flex-col gap-2">
            <h1 className="bg-gradient-to-r from-gsl-light-green to-gsl-dark-orange inline-block text-transparent bg-clip-text text-3xl lg:text-5xl text-center pb-3 border-b-[0.2rem] border-b-orange-400">
          ...
          {/* <div className="my-5 lg:my-10 relative w-full mx-auto h-full overflow-auto lg:w-[70%] shadow-2xl rounded-xl">
            <table className="w-full bg-white border-stone-50 border-2 overflow-hidden">
              <thead className="text-base lg:text-xl overflow-hidden">
                <tr className="border-2 bg-gsl-light-green text-white overflow-hidden">
          ...
          {/* <div className="my-5 lg:my-10 relative w-full h-full overflow-auto lg:w-[90%] shadow-2xl rounded-xl">
            <table className="w-full bg-white border-stone-50 border-2">
              <thead className="text-base lg:text-xl">
                <tr className="border-2 bg-gsl-light-green text-white">
        ...
        {/* <div className="my-2 mb-10 lg:mb-28 flex flex-col mx-auto justify-center items-center lg:w-[80%] gap-3 p-2 lg:p-5 shadow-xl w-[90%] bg-white rounded-xl border-t-4 border-t-gsl-dark-orange">
